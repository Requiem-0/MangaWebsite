  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <nav class="col-md-3 col-lg-2 mngmanga-sidebar d-md-block">
        ...
        <a href="<%= request.getContextPath() %>/ManageChapterController?action=list">Manage Chapter</a>
...
<div class="modal fade" id="addMangaModal" tabindex="-1" aria-labelledby="addMangaModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <!-- UPDATED: added enctype="multipart/form-data" -->
      <form action="<%= request.getContextPath() %>/ManageMangaController" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="half-width">
              <label for="mangaImageFile">Manga Cover Image</label>
              <input type="file" id="mangaImageFile" name="mangaImageFile" class="form-control" accept="image/*">
            </div>
